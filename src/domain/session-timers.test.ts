...
import { formatSessionTimer, PAYMENT_WINDOW_SECONDS, remainingSeconds, renewSessionDeadline, SESSION_WINDOW_SECONDS } from "./session-timers";
...
it("memperpanjang sesi dari waktu pengguna menekan continue", () => {
  expect(renewSessionDeadline(1_000)).toBe(901_000);
  expect(renewSessionDeadline(1_000, 60)).toBe(61_000);
});
